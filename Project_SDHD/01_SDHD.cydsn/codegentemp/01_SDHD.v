// ======================================================================
// 01_SDHD.v generated from TopDesign.cysch
// 07/11/2020 at 23:50
...
module WaveDAC8_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("b2fca35f-a0b7-4726-aa8f-ffb8a9c5cfc8/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
...
module ADC_DelSig_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("5aeff47c-5fb6-408d-9426-0d22b0813a5c/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("5aeff47c-5fb6-408d-9426-0d22b0813a5c/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("dce7d2ef-68c4-4c46-85df-7971bebff707"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_YellowLED_net;
	wire [0:0] tmpFB_0__Pin_YellowLED_net;
	wire [0:0] tmpIO_0__Pin_YellowLED_net;
	wire [0:0] tmpINTERRUPT_0__Pin_YellowLED_net;
	electrical [0:0] tmpSIOVREF__Pin_YellowLED_net;

	cy_psoc3_pins_v1_10
		#(.id("f37c43fa-9d74-4eb0-bbbe-b699608d7ed2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_YellowLED
		 (.oe(tmpOE__Pin_YellowLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_YellowLED_net[0:0]}),
		  .io({tmpIO_0__Pin_YellowLED_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_YellowLED_net),
		  .interrupt({tmpINTERRUPT_0__Pin_YellowLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_YellowLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ef41fea3-0af0-4ba9-a1aa-062eeb2c9a63"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
